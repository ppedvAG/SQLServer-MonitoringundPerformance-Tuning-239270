...
select * from sp_dbccindizes
where indexlevel=2
order by IndexLevel desc, PrevPagePID --152808--> 341 Seiten--> 65 Seiten
...
DBCC PAGE (NwindBig, 1, 152808, 3) --alle von a bis z aber nur 341 von 2 mio 

DBCC PAGE (NwindBig, 1, 106349, 3)---a lle von oropi bis otm.. aber nur ein teil

DBCC TRACEON (3604)

DBCC PAGE (NwindBig, 1, 108262, 3)
